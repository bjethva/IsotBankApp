...
import isot.bank.application.config.Constants;
import isot.bank.application.domain.Authority;
import isot.bank.application.domain.User;
import isot.bank.application.repository.AuthorityRepository;
import isot.bank.application.repository.UserRepository;
import isot.bank.application.security.AuthoritiesConstants;
import isot.bank.application.service.MailService;
import isot.bank.application.service.UserService;
import isot.bank.application.service.dto.PasswordChangeDTO;
import isot.bank.application.service.dto.UserDTO;
import isot.bank.application.web.rest.errors.ExceptionTranslator;
import isot.bank.application.web.rest.vm.KeyAndPasswordVM;
import isot.bank.application.web.rest.vm.ManagedUserVM;
