...
import isot.bank.application.config.audit.AuditEventConverter;
import isot.bank.application.domain.PersistentAuditEvent;
...
import static isot.bank.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
