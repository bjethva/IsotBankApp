package isot.bank.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, isot.bank.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, isot.bank.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
